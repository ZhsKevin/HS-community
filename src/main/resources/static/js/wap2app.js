    ...
    if(navigator.userAgent.indexOf("Html5Plus") > -1) {
        ...
        if (os.isAndroid || os.isPhone) {//手机
           ...
           if('/p/'==pathname.substring(0,3)||'/news/'==pathname.substring(0,6)){
               //window.location.href=window.location.href.replace("https","hschoolcn");
               setTimeout(function(){
                   window.location.href=window.location.href.replace("https","hschoolcn");
                 },500);
           }
...
function downloadApp(){
    ...
    setTimeout(function(){//设置1S的延迟
        if(isAndroid){
            window.location.href="https://qcdn.hschool.hshuai.xyz/static/app/hschoolForum_latest.apk";
        }else if(isIPhone||isTablet){
            swal({
                icon: "info",
                title: "hschoolForum for IOS is coming！",
            });
        }else {
            swal("您未处于移动访问状态，请选择适合您移动设备的版本",{
                ...
                case "android":
                    ...
                    break;
                case "ios":
                    window.location.href="https://qcdn.hschool.hshuai.xyz/static/app/hschoolForum_latest.ipa";
                    break;
                  /*  swal({
                        icon: "info",
                        title: "hschoolForum for IOS is coming！",
