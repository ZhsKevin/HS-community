...
public class JavaMailUtils {
    ...
    //public static String userName = "H&S社区用户";
    ...
    //public static String code = String.valueOf(new Random().nextInt(899999) + 100000);
    ...
    //setCode(String.valueOf(new Random().nextInt(899999) + 100000));
...
//                +"以完成验证。如非本人操作，请忽略此邮件，由此给您带来的不便请谅解！", "text/html;charset=UTF-8");
        message.setContent(
                "<!DOCTYPE html>\n" +
                         ...
                         "<P>亲爱的用户：</P></DIV>\n" +
                         "<P>您好！您正在H&S旗下"+siteName+"进行邮箱验证，本次请求的验证码为：</P>\n" +
                         ...
                         "<P>"+siteName+"官方社区</P>\n" +
                         "<P><SPAN style=\"BORDER-BOTTOM: #ccc 1px dashed; POSITION: relative; _display: inline-block\" t=\"5\" times=\"\" isout=\"0\">如非本人操作，请忽略此邮件，由此给您带来的不便请谅解！</SPAN></P></DIV>\n" +
                         "<br>" +
