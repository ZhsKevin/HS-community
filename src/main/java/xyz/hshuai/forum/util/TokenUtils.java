...
public class TokenUtils {
    //private static final String SECRET = "xyz.hshuai.sso";
    ...
    public static ResultDTO verifyToken(String token) throws Exception {
        ...
        JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256(SECRET)).withIssuer("hschoolUser").build();
        try {
